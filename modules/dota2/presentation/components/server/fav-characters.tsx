...
async function FavCharacters({ playerId }: FavCharactersProps) {
  const heroesConstants = await ConstantsService.getHeroesConstants();
  const heroes = await PlayerService.get3FavouriteHeroes(playerId);
